...
| Atv04TratarErrosDeMuitos | exibe todos os comentários recebidos | ✅ | ❌ | ReferenceError: useState is not defined |
| Atv04TratarErrosDeMuitos | mantém o texto inicial quando a requisição falha | ✅ | ❌ | ReferenceError: useState is not defined |
